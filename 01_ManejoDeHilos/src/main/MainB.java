...
public class MainB {
	...
	public static void main(String[] args) {
		...
		/* 1. PODEMOS IMPLEMENTAR LA INTERFAZ RUNNABLE DIRECTAMENTE EN UNA CLASE ABSTRACTA
		...
		/* 2. PODEMOS IMPLEMENTAR LA INTERFAZ EN UNA CLASE (PRIMOS RUNNABLE) Y LUEGO CREAR EL OBJETO*/
		PrimosRunnable r1 = new PrimosRunnable(n1);
		UnoAMilMillones hilo2 = new UnoAMilMillones(n2);
		
		/* 3. PODEMOS IMPLEMENTAR DIRECTAMENTE LA INTERFAZ RUNNABLE CON UNA FUNCIÓN LAMBDA*/
		Runnable r2 = () -> {
